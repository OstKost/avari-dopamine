...
- [ ] Сгенерированные точки всегда в диапазоне [100, 500] метров от заданных координат (`INV-03`) — property-based тест обязателен
- [ ] Генерируется 5-8 точек за один вызов (`FR-PICKUP-01`)
- [ ] При недоступности геолокации — fallback на координаты Ростова-на-Дону (`FR-PICKUP-01`)
- [ ] Пользователь может сменить активный ПВЗ до оформления заказа (обеспечивается вместе с EPIC-04)
