// Package contracts — order.go — зарезервировано для интерфейсов,
// экспортируемых модулем order (см. EPIC-05).
//
// Пока модуль order не реализован, этот файл существует только чтобы
