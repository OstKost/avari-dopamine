// Package contracts — payment.go — зарезервировано для интерфейсов,
// экспортируемых модулем payment (см. EPIC-06).
//
// Пока модуль payment не реализован, этот файл существует только чтобы
